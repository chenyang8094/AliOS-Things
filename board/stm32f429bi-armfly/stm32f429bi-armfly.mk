...
GLOBAL_LDFLAGS += -T board/stm32f429bi-armfly/STM32F429BITx_FLASH.ld
endif

CONFIG_SYSINFO_PRODUCT_MODEL := ALI_AOS_f429-armfly
CONFIG_SYSINFO_DEVICE_NAME := f429-armfly
